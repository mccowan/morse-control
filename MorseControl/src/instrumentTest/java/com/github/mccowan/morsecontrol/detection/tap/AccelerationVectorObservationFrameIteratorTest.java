package com.github.mccowan.morsecontrol.detection.tap;
...
public class AccelerationVectorObservationFrameIteratorTest {
    ...
    final static List<AccelerationVectorObservation> OBSERVATIONS = Arrays.asList(
            g(0),
            g(10),
            g(25),
            g(50),
    ...
    final static List<List<AccelerationVectorObservation>> FIFTY_NS_EXPECTED_FRAMES = Arrays.asList(
            Arrays.asList(g(0), g(10), g(25), g(50)),
            Arrays.asList(g(250), g(251), g(251), g(258), g(300)),
            Arrays.asList(g(251), g(251), g(258), g(300), g(301))
            );
